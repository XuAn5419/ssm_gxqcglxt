...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>区域管理 <span class="c-gray en">&gt;</span> 区域查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="4">区域查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${areaxList}" var="areax">
				<tr class="text-c">
					<td class="center">${areax.areaxname}</td>
					<td class="center">${areax.addtime}</td>
					<td class="center">${areax.memo}</td>
				</tr>
			</c:forEach>
		</table>
		<div class="cl pd-5 mt-20"></div>
		<div class="text-c">
			<form action="areax/queryAreaxByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						<option value="areaxname">按区域名称查询</option>
