	...
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="admin/updateAdmin.action" name="myform" method="post">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<span class="select-box"><input type="radio" name="role" value="车辆管理员" title="车辆管理员" ${users.role == "车辆管理员"?"checked":""}>车辆管理员
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="role" value="系统管理员" title="系统管理员" ${users.role == "系统管理员"?"checked":""}>系统管理员</span>
				</div>
			</div>
			<div class="row cl">
