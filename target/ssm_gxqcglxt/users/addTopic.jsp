					...
					<div class="userCenterBox boxCenterList clearfix" style="_height: 1%;">
						...
						<form action="index/addTopic.action" name="myform" method="post">
							<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
								...
								<tr>
									<td width="28%" align="right" bgcolor="#FFFFFF">车辆：</td>
									<td width="76%" align="left" bgcolor="#FFFFFF">${orders.carsno }</td>
								</tr>
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF"><input type="radio" name="num" id="tnum" value="1"><img
										src="themes/ecmoban_dangdang/images/stars1.gif" /> &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="num"
										id="tnum" value="2"><img src="themes/ecmoban_dangdang/images/stars2.gif" /> &nbsp;&nbsp;&nbsp;&nbsp;
										<input type="radio" name="num" id="tnum" value="3"><img
										src="themes/ecmoban_dangdang/images/stars3.gif" /> &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="num"
										id="tnum" value="4"><img src="themes/ecmoban_dangdang/images/stars4.gif" /> &nbsp;&nbsp;&nbsp;&nbsp;
										<input type="radio" name="num" id="tnum" value="5" checked><img
