						...
						<form name="formEdit" action="index/personal.action" method="post" onsubmit="return userEdit()">
							<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
								...
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF"><input name="idcard" type="text" size="25" class="inputBg" id="idcard"
										value="${sessionScope.users.idcard }" /></td>
								</tr>
								<tr>
									<td width="28%" align="right" bgcolor="#FFFFFF">驾驶证号：</td>
									<td width="76%" align="left" bgcolor="#FFFFFF"><input name="drivecard" type="text" size="25" class="inputBg" id="image"
										value="${sessionScope.users.drivecard }" onclick="selimage();" readonly="readonly"/><input type="button"  onclick="selimage();" value="选择">	</td>
								</tr>
								<tr>
